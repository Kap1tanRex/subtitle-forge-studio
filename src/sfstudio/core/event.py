...
class SubtitleEvent:
    ...
    #: Рабочее состояние: черновик, готово, вопрос. Пусто — без пометки.
    #: Живёт в ``[Script Info]``, а не в полях строки: см. core.workflow.
    status: str = ""
    #: Заметка к реплике: о чём спросить заказчика, что проверить.
    note: str = ""
