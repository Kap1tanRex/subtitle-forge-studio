...
возврат любого действия, автосохранение, тёмная и светлая темы, настраиваемые
горячие клавиши.
...
1435 тестов. Графические идут без экрана, для медиа генерируется настоящий MKV
с заранее известным содержимым — внешние файлы не нужны. Тесты, которым нужны
