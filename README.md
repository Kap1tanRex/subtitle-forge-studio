...
ширину, справа одна колонка со всеми свойствами. В колонке вкладки — реплика,
текст, кадр, проверки, оформление, акторы, замечания, — и любую из них можно
вынести в отдельное окно кнопкой в её углу. Закрытие этого окна возвращает
вкладку на место. Раскладка переключается в меню «Вид → Раскладка».
